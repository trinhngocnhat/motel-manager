...
fun RevenueManagementScreen(navController: NavController) {
    Scaffold(
        topBar = { CommonHeader(roleName = "QUẢN LÝ DOANH THU", navController = navController, showBackButton = true) }
    ) { innerPadding ->
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            Text(text = "Trang quản lý doanh thu")
            // TODO: Add Revenue Management UI components here
        }
    }
}
...
@Composable
fun RevenueManagementScreenPreview() {
